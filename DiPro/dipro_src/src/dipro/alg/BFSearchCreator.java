...
public class BFSearchCreator implements SearchCreator {

	@Override
	public BF createSearch(Context context) throws Exception {
		BFStar alg = new BFStar();
	...
	@Override
	public BF createSearch(Context context, boolean lengthHeuristic) throws Exception {
		BFStar alg = new BFStar();
		Comparator<Double> comparator = new DoubleComparator();
		EvaluationFunction evaluationFunction;
		if(lengthHeuristic)
		{
			evaluationFunction = new EvaluationFunctionLength(alg);
		}
		else
		{
			evaluationFunction = new EvaluationFunction(alg);
		}
		alg.bind(context, comparator, evaluationFunction);
		return alg;
	}
