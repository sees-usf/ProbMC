...
public class MultiplicativeSearchCreator implements SearchCreator {
	...
	public BF createSearch(Context context) throws Exception {
		...
		MultiplicativeEvaluationFunction evaluationFunction = new MultiplicativeEvaluationFunction(
				alg);
