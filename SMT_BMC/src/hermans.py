...
def GetProperty(path_length):
    """ Property """
    current_x1 = Bool("x1.{0}".format(path_length-1))
    next_x1 = Bool("x1.{0}".format(path_length))
    current_x2 = Bool("x2.{0}".format(path_length-1))
    next_x2 = Bool("x2.{0}".format(path_length))
    current_x3 = Bool("x3.{0}".format(path_length-1))
    next_x3 = Bool("x3.{0}".format(path_length))
